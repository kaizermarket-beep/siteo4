...
export const templates: TemplateDefinition[] = [
  ...
  },
  {
    slug: "salon-prestige",
    name: "Salon Prestige",
    description: "Un design sombre et élégant, animé, pour un salon haut de gamme qui inspire confiance.",
    category: "coiffeur",
    isPremium: true,
    featured: true,
    schema: {
      ...
      defaultBlocks: [
        {
          ...
          position: 10,
          content: {
            headline: "L'excellence capillaire, signée par nos experts",
        ...
        },
        {
          ...
          content: {
            ...
            items: [
              { icon: "✂️", title: "Coupe & structure", description: "Une coupe pensée pour votre morphologie et votre style de vie." },
              { icon: "🎨", title: "Coloration sur-mesure", description: "Des techniques haut de gamme pour un résultat naturel et durable." },
              { icon: "💆", title: "Rituels premium", description: "Soins capillaires signature dans un cadre feutré et raffiné." },
            ],
          },
        },
        {
  ...
  {
    slug: "artisan-du-quartier",
    name: "L'Artisan du Quartier",
    description: "Une ambiance simple et rassurante, pour un artisan de proximité.",
    category: "artisan",
    isPremium: false,
    schema: {
      blockTypes: blockTypeDefs,
      ...
      defaultBlocks: [
        {
          ...
          position: 10,
          content: {
            headline: "L'artisan de confiance, près de chez vous",
            subheadline: "Interventions rapides et soignées pour tous vos travaux du quotidien.",
            ctaLabel: "Demander un devis gratuit",
            ctaLink: { href: "#contact", label: "Demander un devis gratuit" },
            heroVariant: "blobs",
          },
        },
        {
          ...
          content: {
            title: "Nos interventions",
            items: [
              { icon: "🛠️", title: "Petits travaux", description: "Plomberie, électricité, bricolage — rien n'est trop petit." },
              { icon: "🚨", title: "Urgences", description: "Une intervention rapide en cas de besoin." },
              { icon: "💶", title: "Prix justes", description: "Des devis clairs, sans surprise." },
            ],
          },
        },
        {
          ...
          content: {
            title: "Nos interventions",
            images: [
              { image: { url: "https://placehold.co/600x600?text=Quartier+1", alt: "Intervention 1" }, caption: "" },
              { image: { url: "https://placehold.co/600x600?text=Quartier+2", alt: "Intervention 2" }, caption: "" },
              { image: { url: "https://placehold.co/600x600?text=Quartier+3", alt: "Intervention 3" }, caption: "" },
            ],
          },
        },
        {
          ...
          content: {
            ...
            plans: [
              { name: "Devis", price: "Gratuit", period: "", features: ["Sans engagement"], ctaLabel: "Demander un devis", highlighted: true },
              { name: "Intervention standard", price: "Dès 45€", period: "", features: ["Déplacement inclus"], ctaLabel: "Demander un devis", highlighted: false },
              { name: "Urgence", price: "Sur devis", period: "", features: ["Intervention sous 24h"], ctaLabel: "Demander un devis", highlighted: false },
            ],
          },
        },
        {
          ...
          content: {
            ...
            address: "Intervention dans un rayon de 20 km autour de Rennes",
